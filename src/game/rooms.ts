...
export const ROOM_CONFIGS: RoomConfig[] = [
  ...
  // 2. Blood Corridor
  {
    ...
    ambientColor: '#ff2222', ambientIntensity: 0.4,
    pointLightColor: '#ff3333', pointLightIntensity: 1.5,
    fogColor: '#1a0505', fogNear: 3, fogFar: 16,
  ...
  // 3. Abandoned Hospital
  {
    ...
    ambientColor: '#88ccaa', ambientIntensity: 0.5,
    pointLightColor: '#66ffaa', pointLightIntensity: 1.6,
    fogColor: '#1a2a1a', fogNear: 4, fogFar: 18,
  ...
  // 4. Cursed Library
  {
    ...
    ambientColor: '#ccaa55', ambientIntensity: 0.5,
    pointLightColor: '#ffcc44', pointLightIntensity: 1.4,
    fogColor: '#2a1a08', fogNear: 4, fogFar: 17,
  ...
  // 5. Ritual Chamber
  {
    ...
    ambientColor: '#cc33ff', ambientIntensity: 0.4,
    pointLightColor: '#aa22ee', pointLightIntensity: 1.3,
    fogColor: '#1a0818', fogNear: 3, fogFar: 15,
  ...
  // 6. Mirror Hallway
  {
    ...
    ambientColor: '#aaaaff', ambientIntensity: 0.5,
    pointLightColor: '#8888ff', pointLightIntensity: 1.5,
    fogColor: '#1a1a2a', fogNear: 4, fogFar: 18,
  ...
  // 7. Underground Basement
  {
    ...
    pointLightColor: '#44cc44', pointLightIntensity: 1.1,
    fogColor: '#0a1a0a', fogNear: 2, fogFar: 14,
    ghostLevel: 2, fearMultiplier: 2.0, hasWhispers: true, lightFailure: true,
  ...
  // 8. Haunted Child Bedroom
  {
    ...
    ambientColor: '#ffaacc', ambientIntensity: 0.45,
    pointLightColor: '#ff88aa', pointLightIntensity: 1.3,
    fogColor: '#2a1a2a', fogNear: 3, fogFar: 16,
  ...
  // 10. The Exit Corridor (final)
  {
    ...
    ambientColor: '#ee4444', ambientIntensity: 0.35,
    pointLightColor: '#ff4444', pointLightIntensity: 1.0,
    fogColor: '#200808', fogNear: 2, fogFar: 12,
